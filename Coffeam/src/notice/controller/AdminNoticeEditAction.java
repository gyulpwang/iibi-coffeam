...
public class AdminNoticeEditAction extends AbstractAction {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		System.out.println("num = "+num+", title = "+title+", contents = "+contents+", upfile : "+upfile);
		...
		nvo.setNum(Integer.parseInt(num));
		nvo.setTitle(title);
		nvo.setContents(contents);
		nvo.setUpfile(upfile);
