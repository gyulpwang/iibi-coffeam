...
public class AdminFreeBoardInsertAction extends AbstractAction {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		try{
			...
			String idx = mr.getParameter("adminNo");	// int
			String title = mr.getParameter("title");
			String contents = mr.getParameter("contents");
			String writer = mr.getParameter("adminName");
			//String wdate = req.getParameter("wdate");	//Date
			String cnt = mr.getParameter("cnt");	// int
			
			// 2. 유효성 체크
			if(idx==null || idx.trim().isEmpty()){
				this.setViewPage("coffeam_adminFreeBoard.jsp");
			...
			String loc = (n>0)? "admin-fb-list.do" : "javascript:history.back()";
			...
			req.setAttribute("loc", loc);
			this.setRedirect(false);
			this.setViewPage("coffeam_adminWritePosting.jsp");
		}
	}
}
*/