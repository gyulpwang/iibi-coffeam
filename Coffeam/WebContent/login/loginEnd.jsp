...
<!-- loginEnd.jsp -->
<%
	// 1. 사용자가 입력한 값 - 아이디, 비번 받기
	String userid = request.getParameter("userid");
	String pwd = request.getParameter("pwd");
	
	// 아이디 저장에 체크했는지 받아보자.
	String saveUid=request.getParameter("saveUid");
	System.out.println("saveUid ==> "+saveUid);
	...
	user.member.MemberVO loginUser=cdao.loginCheck(userid.trim(), pwd.trim());
	if(loginUser!=null){
