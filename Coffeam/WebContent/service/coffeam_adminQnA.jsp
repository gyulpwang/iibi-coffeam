		...
		<tbody>
			...
			<c:if test="${QAList ne null and not empty QAList}">
				...
				<tr id="tr${i.count}">
					...
					<td width="25%">${qvo.title}</td>
					<td width="15%" align="center">${qvo.writer}</td>
					<td width="10%" align="center">${qvo.yn}</td>
					<td width="20%" align="center">
						<button type="button" class="btn btn-success" style="margin-bottom: 0.5em" onclick="showQnAPlus(${qvo.num}, '${qvo.yn}', ${i.count})">조회</button>
