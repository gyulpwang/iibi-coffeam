...
<div class="col-md-12">
	<div class="row box">
		<form name="qf" id="qf" role="form" method="POST" action="q-insert.do">
	...
	<table class="table">
		...
		<tbody>
			<tr>
				<th width="20%">제목</th>
				<td><input type="text" style="width:90%;" name="title"	id="title" placeholder="질문 제목을 입력하세요" class="form-control"></td>
			</tr>
			<tr>
				<th>작성자</th><td>${loginUser.userid}</td>
			</tr>
			<tr>
				<th>내용</th><td><textarea style="width:90%" name="contents" id="contents" class="form-control" rows="10" placeholder="질문 내용을 입력하세요" ></textarea></td>
			</tr>
			<tr>
