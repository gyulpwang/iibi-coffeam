					...
					<c:forEach var="nvo" items="${NTCList}" varStatus="i">
						<tr id="tr${i.count}">
							...
							<td width="25%" align="center">
								...
								<button type="button" class="btn btn-warning" style="margin-bottom: 0.5em" onclick="ntcEdit(${nvo.num})">수정</button>
								<button type="button" class="btn btn-danger"  style="margin-bottom: 0.5em"onclick="ntcDel(${nvo.num})">삭제</button>
							</td>
						</tr>
					</c:forEach>
					<tr>
